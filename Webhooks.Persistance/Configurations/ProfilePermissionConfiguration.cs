...
public class ProfilePermissionConfiguration : IEntityTypeConfiguration<ProfilePermission>
{
    public void Configure(EntityTypeBuilder<ProfilePermission> builder)
    {
        ...
        builder.HasData(AssignPermissions("OrderManager", Domain.Enums.Permission.CreateOrders,
            Domain.Enums.Permission.ReadOrders));
        builder.HasData(AssignPermissions("UserManager", Domain.Enums.Permission.ReadProfiles,
            Domain.Enums.Permission.AssignProfiles));
        builder.HasData(AssignPermissions("Subscriber", Domain.Enums.Permission.CreateSubscriptions));
    }

    private static IEnumerable<ProfilePermission> AssignPermissions(string profileName,
        params Domain.Enums.Permission[] permissions)
    {
